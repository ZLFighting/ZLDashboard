...
- (void)setupJumpNOView {
    ...
    // TODO:提示语
    _markedLabel = [[UILabel alloc] initWithFrame:CGRectMake(xPixel, CGRectGetMaxY(_showLable.frame), width, 20)];
    ...
    _markedLabel.font = [UIFont systemFontOfSize:16.f];
